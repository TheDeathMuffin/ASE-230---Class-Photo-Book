	...
	<body style="font-family: Arial, sans-serif; background-color: #9c9c9c;">
		...
		<div class="" style="background-color: #9c9c9c;">
			...
			<div class="bg-image" style="
				background-image: url('images/nerd2.png');
				background-size: contain;">
				<div class="" style="background-color:rgba(53, 53, 102, 0.8); padding: 90px;"><center><p style="font-size: 80px; color: #4bcfed;">ASE 230</p><img src="images/titleIcon.png" alt=""><br><br><h2 style="color: #dddddd;">This is Our Class</h2><h4 style="color: #dddddd;">The finest ASE 230 has ever seen...</h4></center></div>
			</div>
			</div>
			<!--Student List Div-->
			<div class="" style="background-color: #353566">
				<!--Student List Div - defines window size-->
				<div class="row" style="margin-left: 15%; margin-right: 15%; width: 70%; padding-top: 30px;">
					<!--Repeated Student Card-->
					<?php 
						$i = 0;
						for ($x = 0; $x <= 11; $x++) {
						if ($i == 0 || $i == 2) {
						...
						?>
						<div class="col-md-4 col-sm-6 col-xs-12 content" style="background-color: #353566; height: 450px;">
							...
							<div class="rounded shadow" style="background-color: <?=$color?>; padding: 15px; height: 90%; <!--border-style: groove;-->">
									<a href="detail2.php?Index=<?=$x?>"><center><img class="rounded-circle z-depth-2" alt="100x100" src="<?=$masterArray[$x]["img"]?>" style="width: 80%; margin-bottom: 12px; border: solid black 3px;"></center></a>
					...
					<div class="rounded" style="position: fixed; left: 15px; bottom: 30px; background-color: #494954; padding: 10px;">
						<a href="delete.php" style="color: #4bcfed; font-size: 130%;">Create Student</a>
					</div>
				</div>
			</div>
