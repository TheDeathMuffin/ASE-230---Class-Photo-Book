		...
		<div class="" style="background-color: #9c9c9c;">
			...
			<div class="" style="background-color: #353566; margin-bottom; padding-bottom: 15px;">
				<div class="" style="margin-left: 15%; margin-right: 15%;">
					<!--Name Title Bar Div-->
					<div class="" style="padding-left: 10px;"><p style="font-size: 70px; color: #4bcfed; margin-left: -10px; height: 503px;"><?=$message?></p></div>

				</div>
			</div>
			<!--Footer Bar Div-->
			<div class="" style="position: abtolute; left: 0; right: 0; bottom: 0; padding: 10px; background-color: #4bcfed; margin-top: 5px; height: 20px;"><h1 style=""></h1></div>
		</div>
	</body>
</html>