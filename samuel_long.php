		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-md-6">
					...
					<div class="mb-2 d-flex">
						...
						<div class="social d-flex ml-auto">
							...
							<a href="<?php echo 'https://www.facebook.com/' ?>" class="text-muted mr-1">
								<i class="fab fa-facebook-f"></i>
							</a>
							<a href="<?php echo 'https://twitter.com/?lang=en' ?>" class="text-muted mr-1">
								<i class="fab fa-twitter"></i>
							</a>
							<a href="<?php echo 'https://www.instagram.com/' ?>" class="text-muted mr-1">
								<i class="fab fa-instagram"></i>
							</a>
							<a href="<?php echo 'https://www.linkedin.com/' ?>" class="text-muted">
					...
					<label class="media-body"><?php echo 'Web Developer/Backend-Programmer'; ?></label>
					</li>
					<li class="media">
					<span class="w-25 text-black font-weight-normal">Dream company: </span>
					<label class="media-body"><?php echo 'Tesla'; ?></label>
					</li>
					<li class="media">
					<span class="w-25 text-black font-weight-normal">Email: </span>
					<label class="media-body"><?php echo 'longs6@mymail.nku.edu'; ?></label>
					</li>
					</ul>
					</div>
				</div>
				<div class="col-lg-7 col-md-6 pl-xl-3">
					...
					<p><?php echo 'Living is changing. Unliving things do not change, at least not by their own will. So if you want to live, you must be prepared to let (or make) yourself change. It sounds easy to do, but can be very dificult because change often comes with discomfort and that is why learning to embrace that discomfort is so powerful.'; ?></p>
					<div class="my-2 bg-light p-2">
						<p class="font-italic mb-0"><?php echo 'Once someone decides to stop changing, they become stagnated in the past and the present passes them by.'; ?></p>
					</div>
					...
					<div class="py-1">
						<div class="progress">
							<div class="progress-bar" role="progressbar" style="width: 10%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
								...
								<span class="progress-bar-number"><?php echo '10%'; ?></span>
							</div>
						</div>
					</div>
					<div class="py-1">
					...
					<div class="py-1">
						<div class="progress">
							<div class="progress-bar" role="progressbar" style="width:6%" aria-valuenow="77" aria-valuemin="0" aria-valuemax="100">
								...
								<span class="progress-bar-number"><?php echo '6%'; ?></span>
							</div>
						</div>
					</div>
					<h5 class="font-weight-normal">Fun fact</h5>
					<p><?php echo 'It is a general trend that the older one gets, the more set in their ways they become and consequently the less they are able to or are willing to accept and adhere to the new.'; ?></p>
